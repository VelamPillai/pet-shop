...
export default function Home() {
  const slides = [{url: 'https://images.unsplash.com/photo-1615266895738-11f1371cd7e5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1169&q=80'},
     /* {
  ...
  return (
    <div>
      <div className="w-full h-[70vh] mx-auto my-[3rem]" >
