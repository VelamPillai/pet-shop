...
export default function Welcome() {
  return (
    <div className='flex justify-center items-center mt-16 flew-wrap'>
        <div className='w-[50%]'>
          <h2 className='text-[28px] font-bold leading-9 '>Welcome to our shop</h2>
          <p className='text-[16px] leading-24 my-4'>At FirstVet you will only find the highest quality products for your pet. We focus on products that enhance your pet's health and wellbeing like veterinary diet dog food, veterinary diet cat food and supplements.</p>
        ...
        <img src={welcomeImage}  alt="welcomeImage" className='w-[50%]' />
    </div>
  )
}
