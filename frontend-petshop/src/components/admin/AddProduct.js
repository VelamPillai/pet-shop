...
export default function AddProduct() {
  ...
  return (
    <div>
      <div className="flex justify-center items-center flex-wrap flex-col xl:flex-row  lg:border m-auto rounded shadow-black shadow-xs  mt-[3rem]  sm:mt-[1rem] bg-orange-200/50 p-3">
        <Toaster />
        ...
        >
          <label className="flex flex-col  justify-center item-center text-xs  sm:text-md  sm:items-start m-[.25rem]  ">
            Pet Name :{" "}
            <input
              className="border border-slate-200 rounded w-[150px]  sm:w-[300px] h-[50px] "
              type="text"
              name="petName"
          ...
          <label className="flex flex-col justify-center item-center text-xs  sm:text-md  sm:items-start m-[.25rem]  ">
            ...
            <div className="flex flex-row">
              <input
                ...
                className="border border-slate-200 rounded w-[150px]  sm:w-[350px] h-[50px] "
              />
