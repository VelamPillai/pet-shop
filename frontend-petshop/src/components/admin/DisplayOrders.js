...
export default function DisplayOrders() {
  ...
  return (
    <div className="w-[100%] flex flex-col items-center mt-[3rem]  sm:mt-1">
      ...
      <div>
        <div className="flex justify-around  items-center flex-col  sm:flex-row  sm:w-[900px]  sm:h-[100px] bg-green-600/50 rounded-lg m-2 p-4  shadow-black shadow-inner">
                ...
                >
                  ...
                  <div className="flex flex-col  sm:flex-row ">
                    ...
                    <button
                      ...
                      className="text-lg text-red-600 font-bold justify-center items-center  m-3 p-1 rounded shadow-black shadow-md hover:bg-red-100   lg:box-content "
                    >
                      <AiFillDelete />
                    </button>
                  </div>
