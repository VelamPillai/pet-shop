  ...
  return (
    <div className='flex  justify-around items-center bg-orange-600 text-white '>
      ...
      <form className='border border-orange-500  m-6 p-2 w-2/4 bg-white relative'>
        <input text='email' placeholder='Your email address' name='email' onChange={(e) => setEmail(e.target.value)} />
        <button className='uppercase bg-black p-2 absolute right-0 top-0'>Subscribe</button>
      </form>
      <div className='flex '>
