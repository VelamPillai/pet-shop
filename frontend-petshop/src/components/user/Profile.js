      ...
      <div className="flex  flex-col justify-center items-center  xl:flex-row w-[100%]  lg:border mx-auto my-[1rem]  sm:m-[1rem] rounded shadow-black shadow-lg">
        <div className="flex flex-col w-[40%]  p-5">
          ...
          <div className="flex justify-center items-center flex-col  sm:flex-row">
            ...
            {/* <button  onClick={ profileHandler} className="bg-gradient-to-r from-orange-500 to-yellow-600 text-xs hover:bg-gradient-to-l justify-center items-center w-[150px]  sm:w-[200px] m-3  sm:mx-[1rem]  sm:my-[1rem]  sm:p-1 rounded shadow-black shadow-md focus:bg-green-600  h-[30px] lg:box-content">
            Notification
            </button> */}
            <button
